...
const ViewRequest = ({route,navigation}) => {
  ...
  var fetchInsertApi="https://lrtextile.com.pk/projectmart/admin/fetch_allrequest.php";
      var headers={
    ...
    return (
      <View> 
        <View >
      <Text style={{marginTop:10,marginBottom:15,fontSize:20,color:"#f9b347",alignContent:'center',justifyContent:'center',textAlign:'center'}}>All Update Profile Request</Text>
     ...
     renderItem={(element)=>{
         return (
          ...
          <TouchableOpacity
          onPress={() => navigation.navigate("BlockRequest",{user_id : element.item.user_id,user_type : element.item.user_type})}>
           ...
           <Text> User Type  : {element.item.user_type}</Text>
           <Text style={{color:'#f9b347',textAlign:'center',marginTop:7,fontWeight:'bold'}}>+Click Box To Approve Request</Text>
