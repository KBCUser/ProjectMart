...
const ViewPitcher = ({route,navigation}) => {
  const [productdata,setproductdata] = useState("");

  var fetchInsertApi="https://lrtextile.com.pk/projectmart/admin/fetch_allpitcher.php";
      var headers={
    ...
    return (
      <View> 
        <View >
      <Text style={{marginTop:10,marginBottom:15,fontSize:20,color:"#f9b347",alignContent:'center',justifyContent:'center',textAlign:'center'}}>All Active Pitcher List</Text>
     ...
     renderItem={(element)=>{
         return (
          ...
          <TouchableOpacity
          onPress={() => navigation.navigate("BlockPitcher",{user_id : element.item.pitcher_id})}>
           ...
           <Text style={{color:'#f9b347',textAlign:'center',marginTop:7,fontWeight:'bold'}}>+Click Box To Block Pitcher</Text>
