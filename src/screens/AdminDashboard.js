...
const AdminDashboard = ({route,navigation})=>{
   ...
   return (
    ...
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("ViewInvestor")}>
    <Image style={styles.lineimage}  source={require("../../assets/investor.png")} />
    ...
    <View style={styles.item}>
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("ViewPitcher")}>
    ...
    <View style={styles.item}>
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("IdeasList")}>
    <Image style={styles.lineimage}  source={require("../../assets/idea.png")} />
    <Text style={styles.linetext}>All Idea's</Text>

    </TouchableOpacity>

    </View>
    <View style={styles.item}>
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("ViewRequest")}>
